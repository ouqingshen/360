...
void CTitleBar::initUI() {
    ...
    QPixmap pixmap(":/mainwindow/resources/logo.svg");
    ...
    m_pTitleTextLabel->setStyleSheet("QLabel { color: white; }");
    m_pTitleTextLabel->setFixedWidth(120);

    m_pMinBtn = new QPushButton(this);
    m_pMinBtn->setFixedSize(32, 32);
    m_pMinBtn->setStyleSheet(
        "QPushButton{background-image:url(:/mainwindow/resources/min.svg);border:none;background-repeat:no-repeat;background-position: top;background-color: transparent}"
    ...
    m_pCloseBtn->setStyleSheet(
        "QPushButton{background-image:url(:/mainwindow/resources/close.svg);border:none;background-repeat:no-repeat;background-position: center;background-color: transparent}"
